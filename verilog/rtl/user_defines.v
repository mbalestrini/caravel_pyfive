...
// PyFive - USB
`define USER_CONFIG_GPIO_11_INIT `GPIO_MODE_USER_STD_BIDIRECTIONAL  /* DN */
`define USER_CONFIG_GPIO_12_INIT `GPIO_MODE_USER_STD_BIDIRECTIONAL  /* DP */
`define USER_CONFIG_GPIO_13_INIT `GPIO_MODE_USER_STD_OUTPUT         /* PU */
`define USER_CONFIG_GPIO_14_INIT `GPIO_MODE_USER_STD_OUTPUT         /* SoF */

// PyFive - MIDI uart
`define USER_CONFIG_GPIO_15_INIT `GPIO_MODE_USER_STD_OUTPUT         /* MIDI TX */
`define USER_CONFIG_GPIO_16_INIT `GPIO_MODE_USER_STD_INPUT_PULLUP   /* MIDI RX */

// PyFive - PCM Audio
`define USER_CONFIG_GPIO_17_INIT `GPIO_MODE_USER_STD_OUTPUT         /* PCM Out[0] */
`define USER_CONFIG_GPIO_18_INIT `GPIO_MODE_USER_STD_OUTPUT         /* PCM Out[1] */


// PyFive - Video
`define USER_CONFIG_GPIO_19_INIT `GPIO_MODE_USER_STD_OUTPUT         /* CLK */  
`define USER_CONFIG_GPIO_20_INIT `GPIO_MODE_USER_STD_OUTPUT         /* DE */ 
`define USER_CONFIG_GPIO_21_INIT `GPIO_MODE_USER_STD_OUTPUT         /* HSync */ 
`define USER_CONFIG_GPIO_22_INIT `GPIO_MODE_USER_STD_OUTPUT         /* VSync */ 
`define USER_CONFIG_GPIO_23_INIT `GPIO_MODE_USER_STD_OUTPUT         /* R */ 
`define USER_CONFIG_GPIO_24_INIT `GPIO_MODE_USER_STD_OUTPUT         /* G */ 
`define USER_CONFIG_GPIO_25_INIT `GPIO_MODE_USER_STD_OUTPUT         /* B */ 
`define USER_CONFIG_GPIO_26_INIT `GPIO_MODE_USER_STD_OUTPUT         /* I */ 
